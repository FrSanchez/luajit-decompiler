...
local overwrite_functions = {
	["rate-limiting"] = function (schema)
		...
		if err then
			return false, "feature value '" .. VALUES.REDIS_HOST .. "' should be set when feature flag '" .. FLAGS.RATE_LIMITING_RESTRICT_REDIS_ONLY .. "' is enabled"
		end

		local redis_port, err = feature_flags.get_feature_value(VALUES.REDIS_PORT)

		if err then
			return false, "feature value '" .. VALUES.REDIS_PORT .. "' should be set when feature flag '" .. FLAGS.RATE_LIMITING_RESTRICT_REDIS_ONLY .. "' is enabled"
		end
	...
	["response-ratelimiting"] = function (schema)
		...
		if err then
			return false, "feature value '" .. VALUES.REDIS_HOST .. "' should be set when feature flag '" .. FLAGS.RESPONSE_RATELIMITING_RESTRICT_REDIS_ONLY .. "' is enabled"
		end

		local redis_port, err = feature_flags.get_feature_value(VALUES.REDIS_PORT)

		if err then
			return false, "feature value '" .. VALUES.REDIS_PORT .. "' should be set when feature flag '" .. FLAGS.RESPONSE_RATELIMITING_RESTRICT_REDIS_ONLY .. "' is enabled"
		end
	...
	["rate-limiting-advanced"] = function (schema)
		...
		if err then
			return false, "feature value '" .. VALUES.REDIS_HOST .. "' should be set when feature flag '" .. FLAGS.RATE_LIMITING_ADVANCED_RESTRICT_REDIS_ONLY .. "' is enabled"
		end

		local redis_port, err = feature_flags.get_feature_value(VALUES.REDIS_PORT)

		if err then
			return false, "feature value '" .. VALUES.REDIS_PORT .. "' should be set when feature flag '" .. FLAGS.RATE_LIMITING_ADVANCED_RESTRICT_REDIS_ONLY .. "' is enabled"
		end

		local redis_namespace, err = feature_flags.get_feature_value(VALUES.REDIS_NAMESPACE)

		if err then
			return false, "feature value '" .. VALUES.REDIS_NAMESPACE .. "' should be set when feature flag '" .. FLAGS.RATE_LIMITING_RESTRICT_REDIS_ONLY .. "' is enabled"
		end
